...
const projects = [
  {
    ...
    name: "Figure8 Maps",
    description:
      "The idea for Figure8 Maps came to me while prepping for a road trip to Maine for hiking and camping. I had a big list of ideas for the trip, but wanted an easier way to visualize and plan each of the days. My solution? A full-stack web app allowing users to create custom interactive maps for trip planning, specifically focused on hiking and camping adventures. It includes authentication for account login, database integration, and Google Maps integration. I built it using React, TypeScript, TailwindCSS, Google Firebase / Firestore, and Netlify for production deployment. I use Figure8 Maps to plan my adventures, remember what I did, and share with friends. You can try it out below!",
    links: [
      {
        id: 0,
        title: "View Website 💻",
        link: "https://figure8maps.com/",
        available: true,
      },
    ],
  },
...
const personalLinks = [
  ...
  },
  {
    id: 2,
    title: "Resume 📄",
    link: "https://drive.google.com/file/d/1Z4ySa9KPaYuvXnzyaKH7DGSOMJph6BM9/view?usp=sharing",
  },
];
