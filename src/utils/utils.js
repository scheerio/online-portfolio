...
const projects = [
    ...
    },
    {
        ...
        description: 'AWS Lambda is a serverless service a lot of tech teams use in projects. I wanted to put together a concise guide and example on how to run AWS Lambda functions locally. This tiny project touches on AWS SAM CLI, API Gateway, and more.',
        links: [
            {
                id: 0,
                title: 'View Repo 💻',
    ...
    },
    {
        ...
        description: 'What does it look like to build a Python-based database? I implemented a simple program that can store, retrieve, and delete information from a database using Python and SQLite. Executing SQL within Python is fun stuff!',
        links: [
            {
                id: 0,
                title: 'View Repo 💻',
